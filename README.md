...
1. Hamburger icon only needed on mobile view. I have the menu opening in mobile view.

2. Might have some issues reading some of the text, not enough contrast.
